...
class Got10k_i(BaseDataset):
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        frame_list_v = [self._get_frame(seq_path, f_id) for f_id in frame_ids]
        frame_list_i = [self._get_frame(seq_path_i, f_id) for f_id in frame_ids]
