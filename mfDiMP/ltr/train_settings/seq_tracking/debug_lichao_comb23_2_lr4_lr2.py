...
from ltr.dataset import Lasot, Got10k_i, TrackingNet#, MSCOCOSeq
...
def run(settings):
    ...
    net = optim_tracker_models.steepest_descent_learn_filter_resnet50_newiou(
        filter_size=settings.target_filter_sz, backbone_pretrained=False, optim_iter=5,
    ...
    optimizer = optim.Adam([{'params': actor.net.classifier.filter_initializer.parameters(), 'lr': lrgain*5e-5},
                            ...
                            {'params': actor.net.feature_extractor_i.parameters(), 'lr':lrgain_i* 2e-5}],
                           lr=lrgain*2e-4)
