...
class ResNet_comb4(nn.Module):
    ...
    def __init__(self, block, layers, output_layers, num_classes=1000, inplanes=64):
        ...
        self.conv1 = nn.Conv2d(4, inplanes, kernel_size=7, stride=2, padding=3,
                               bias=False)
...
def resnet18_comb4(output_layers=None, pretrained=False):
    ...
    model = ResNet_comb4(BasicBlock, [2, 2, 2, 2], output_layers)
...
def resnet50_comb4(output_layers=None, pretrained=False):
    ...
    model = ResNet_comb4(Bottleneck, [3, 4, 6, 3], output_layers)
    if pretrained:
